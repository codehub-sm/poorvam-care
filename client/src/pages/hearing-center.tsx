  ...
  return (
    <>
      ...
      <section className="relative bg-brown-deep overflow-hidden">
        <div className="absolute inset-0 opacity-[0.04]" style={{ backgroundImage: "radial-gradient(circle, #E5A94E 1px, transparent 1px)", backgroundSize: "32px 32px" }} aria-hidden="true" />
        <div className="absolute -top-20 -right-20 w-[400px] h-[400px] bg-gold/8 rounded-full blur-3xl" aria-hidden="true" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          ...
          <div className="hidden lg:flex items-center justify-center">
            <HearingCenterIllustration className="w-full max-w-lg h-auto opacity-80" />
          </div>
          </div>
        </div>
      </section>
