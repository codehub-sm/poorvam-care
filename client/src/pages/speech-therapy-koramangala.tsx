...
export default function SpeechTherapyKoramangalaPage() {
  return (
    <NeighbourhoodPage
      slug="speech-therapy-koramangala-bangalore"
      neighbourhood="Koramangala"
      seoTitle="Speech Therapy in Koramangala Bangalore | Poorvam Care Electronic City"
      seoDescription="Looking for speech therapy near Koramangala, Bangalore? Poorvam Care in Electronic City is 9km away. RCI-licensed therapists. Book a consultation."
      schemaDescription="Speech therapy and early intervention services for families from Koramangala, Bangalore"
      areaServed={[
        "Koramangala",
        "Koramangala 1st Block",
        "Koramangala 5th Block",
        "Indiranagar adjacent",
      ]}
      heroBlurb="Poorvam Care in Electronic City is just 9 km from Koramangala — a 20–25 minute drive via Silk Board or Agara Lake Road. Our RCI-licensed speech-language pathologists deliver evidence-based therapy for children with speech delays, autism, language disorders, and more. Book a consultation today."
      distanceText="Approximately 9 km via Silk Board Junction or Agara Lake Road"
      travelTimeText="Around 20–25 minutes by car under normal traffic conditions"
      teletherapyText="Online speech therapy sessions from your Koramangala home"
      proseHeading="Trusted by Families Across Koramangala"
      prose={[
      ...
      faqTitle="Speech Therapy for Koramangala — Common Questions"
      faqs={[
        {
          question: "Is there a speech therapist near Koramangala?",
          answer:
            "Poorvam Care in Electronic City is a highly regarded speech therapy centre serving families from Koramangala. Located approximately 9 km from Koramangala, our centre is around 20–25 minutes by car. We have RCI-licensed speech-language pathologists who provide assessment and therapy for speech delays, language disorders, autism-related communication challenges, stuttering, and more. Many families from the 1st through 8th Blocks in Koramangala attend our centre regularly.",
        },
        {
          question: "How far is Poorvam Care from Koramangala?",
          answer:
            "Poorvam Care is approximately 9 km from Koramangala. The distance and drive time vary slightly depending on which block you live in. Families from Koramangala 1st Block and 2nd Block typically take around 20 minutes, while those from the 7th Block or 8th Block may take closer to 25 minutes. The journey is straightforward via Hosur Road through Silk Board or via Agara Lake Road.",
        },
        {
          question: "What is the best route from Koramangala to Electronic City?",
          answer:
            "There are two popular routes from Koramangala to Poorvam Care in Electronic City. The first is via Silk Board Junction — take Intermediate Ring Road or 80 Feet Road to Silk Board, then head south on Hosur Road towards Electronic City and exit at Hulimangla Road. The second is via Agara Lake Road — take Inner Ring Road to Agara and join Hosur Road further south. Both routes take around 20–25 minutes in normal traffic conditions. We recommend checking Google Maps for live traffic before heading out.",
        },
        {
          question: "Does Poorvam offer teletherapy for Koramangala families?",
          answer:
            "Yes, Poorvam Care offers online teletherapy sessions for families from Koramangala who prefer to attend therapy from home, particularly during peak traffic hours. Our therapists conduct live video sessions and provide detailed home activity plans. Many Koramangala families — especially those in tech roles with demanding schedules — use a blended model combining fortnightly in-person visits with weekly teletherapy check-ins. Contact us to discuss the best arrangement for your child.",
        },
      ]}
      ctaBody="Families from Koramangala trust Poorvam Care for expert, compassionate speech therapy. Book a consultation and let us create a personalised plan for your child."
    />
  );
}
