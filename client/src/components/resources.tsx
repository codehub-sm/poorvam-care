...
import { BookOpen, Gamepad2, Users, Brain, Heart, GraduationCap, Download } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-baloo font-bold text-gray-800 mb-6">
            Parent <span className="text-blue-600">Resources</span>
          </h2>
          ...
          {resources.map((resource, index) => {
            ...
            return (
              <div key={index} className={`bg-gradient-to-br ${resource.bgGradient} rounded-2xl p-6 hover:shadow-lg transition-all duration-300`}>
                ...
                <h3 className="text-2xl font-baloo font-semibold text-gray-800 mb-4">{resource.title}</h3>
                <p className="text-gray-600 mb-6">
                  {resource.description}
                </p>
                
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-500">PDF • {resource.pages}</span>
                  <button className={`${resource.color} text-white px-4 py-2 rounded-lg hover:opacity-90 transition-colors flex items-center`}>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 mt-12 text-center text-white">
          <h3 className="text-2xl font-baloo font-bold mb-4">Stay Updated with New Resources</h3>
          ...
          <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            ...
            <button 
              ...
              className="bg-white text-blue-600 px-6 py-3 rounded-lg font-bold hover:bg-gray-100 transition-colors disabled:opacity-50"
            >
